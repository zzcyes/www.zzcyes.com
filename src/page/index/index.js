...
// 自动打字
$(function(){
    let  inputStr = "<p>Dear Basketball,</p>"+
        "<br>"+
    ...
    let timer = setInterval(()=>{
        ...
        $("#content").html(`${insertStr(inputStr,-4,'<span id="wink">|</span>')}`);
        ...
        const nScrollHight = $("#content")[0].scrollHeight;
        const nScrollTop = $("#content")[0].scrollTop;
